        ...
        <span><strong>ENAQUEEN</strong></span>
				...
				<div class="collapse navbar-collapse" id="navbarResponsive">
					<ul class="navbar-nav">
						<li class="nav-item dropdown">
							...
							<div class="dropdown-menu dropdown-menu-right" aria-labelledby="navbarDropdownMenuLink">
								...
								<a href="" class="dropdown-item">SUNDANESE</a>
								<a href="" class="dropdown-item">BALINESE</a>
							</div>
						</li>
						<li class="nav-item dropdown">
							<span class="nav-link language" data-toggle="dropdown" id="bahasa">
							...
							<div class="dropdown-menu dropdown-menu-right" aria-labelledby="navbarDropdownMenuLink">
								...
								<a href="" class="dropdown-item">MILKSHAKE</a>
							</div>
						</li>
						<li class="nav-item dropdown">
							<span class="nav-link language" data-toggle="dropdown" id="bahasa">
							...
							<div class="dropdown-menu dropdown-menu-right" aria-labelledby="navbarDropdownMenuLink">
								<a href="" class="dropdown-item">ICE CREAM</a>
					...
					<ul class="navbar-nav ml-4">
						<li class="nav-item">
							<span class="nav-link"><i class="fas fa-shopping-cart fa-lg" style="color:white"></i></span>
						</li>
