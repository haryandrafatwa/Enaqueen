...
<div class="container">
        <div class="row justify-content-center">
            <div class="media-container-column col-lg-8" data-form-type="formoid">
                ...
                <form method="POST" class="mbr-form form-with-styler" id="addProduct" enctype="multipart/form-data" action="<?= base_url();?>Admin/Product/updateFoodProduct">
		  ...
		  if (result.value) {
			swalWithBootstrapButtons.fire(
			  ...
			  'success'
				...
				window.location = "<?= base_url();?>Admin/Product/deleteFoodProduct/<?= $product[$type.'_name'];?>"; 
			});
		  } else if (
