...
<div class="container">
        <div class="row justify-content-center">
            <div class="media-container-column col-lg-8" data-form-type="formoid">
                ...
                <form method="POST" class="mbr-form form-with-styler" id="addProduct" enctype="multipart/form-data" action="<?= base_url();?>Admin/ProductDessert/addProductDessert">
                 <div class="dragArea row">
                        ...
                        <div class="col-md-12 input-group-btn" style="margin-top: 60px">
							<a href="<?= base_url();?>User/Home/Dessert" id="btn-cancel" class="btn btn-primary btn-form-product display-4" style="margin-right: 10px;background-color: rgba(51,51,51,0.5)!important;border:#808080 solid!important;color: white!important;border-radius: 10px!important;padding: 10px">CANCEL</a>
