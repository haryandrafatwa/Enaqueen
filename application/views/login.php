			...
			<div class="container justify-content-center">
				<div id="jumbo-login" class="jumbotron" style="margin-left: auto; margin-right: auto;">
					...
					<div class="row justify-content-center" style="">
						<form action="<?=base_url();?>index.php/Auth/Login" method="post" id="signUpFormUser" style="width: 100%;padding-left: 10%;padding-right: 10%">
							<div class="field justify-content-center" style="">
								<input type="text" name="username_field" required id="username_field" placeholder="">
								<label for="username_field" class="text-label label-placeholder" style="">Username</label>
							</div>
							<div class="field" style="">
								<input required type="password" name="pass_field" id="pass_field" placeholder="">
