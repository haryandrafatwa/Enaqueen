								...
								<div class="col-6">
									<div class="container" style="padding: 0px">
										...
										<div>
											...
											<div class="row" style="margin-top: 4px">
												<div class="col-12">
													<input type="text" style="width: 100%;font-size: 20px" name="streetAdd" value="<?= $address['street']; ?>" required>
												</div>
											</div>
										</div>
										<div>
											...
											<div class="row" style="margin-top: 4px">
												<div class="col-12">
													<input type="text" style="width: 100%;font-size: 20px" name="streetAdd2"  value="<?= $address['street2']; ?>">
												</div>
											</div>
										</div>
										<div>
											...
											<div class="row" style="margin-top: 4px">
												<div class="col-12">
													<input type="text" style="width: 100%;font-size: 20px" name="city"  value="<?= $address['city']; ?>" required>
												</div>
											</div>
										</div>
									</div>
								...
								<div class="col-6">
									<div class="container" style="padding: 0px">
										...
										<div>
											...
											<div class="row" style="margin-top: 4px">
												<div class="col-12">
													<input type="text" style="width: 100%;font-size: 20px" name="building"  value="<?= $address['building']; ?>">
												</div>
											</div>
										</div>
										<div>
											...
											<div class="row" style="margin-top: 4px">
												<div class="col-12">
													<input type="text" style="width: 100%;font-size: 20px" name="state" required value="<?= $address['state']; ?>">
												</div>
											</div>
										</div>
										<div>
											...
											<div class="row" style="margin-top: 4px">
												<div class="col-12">
													<input type="text" style="width: 100%;font-size: 20px" name="zip" onKeyPress="isInputNumber(event)"  value="<?= $address['zip']; ?>" required>
												</div>
											</div>
										</div>
									</div>
